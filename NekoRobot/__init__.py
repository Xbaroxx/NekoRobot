...
def get_user_list(__init__, key):
    with open("{}/NekoRobot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]


# enable logging
FORMAT = "[NekoRobot] %(message)s"
logging.basicConfig(
...
LOGGER.info("NekoRobot is starting. | An NekoRobot Union Project. | Licensed under GPLv3.")
