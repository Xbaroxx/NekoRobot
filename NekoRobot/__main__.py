...
PM_START_TEXT = """
[✨](https://telegra.ph/file/36ab7fcf96c86ecfb44c2.jpg) 'Hai there i'm' [Neko](https://t.me/NekotpiRobot)
────────────────────
Neko a powerful group management bot built to help you manage your group!
────────────────────
...
@run_async
def NekoRobot_about_callback(update, context):
    query = update.callback_query
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                    InlineKeyboardButton(text="Setup Guide", callback_data="aboutmanu_howto"),
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(NekoRobot_about_callback, pattern=r"aboutmanu_")
