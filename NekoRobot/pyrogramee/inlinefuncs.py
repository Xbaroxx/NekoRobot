...
from NekoRobot import EVENT_LOGS, BOT_USERNAME
from NekoRobot import pbot as app 
from NekoRobot import arq
from NekoRobot.utils.keyboard import ikb
from NekoRobot.pyrogramee.tasks import _get_tasks_text, all_tasks, rm_task
from NekoRobot.pyrogramee.types.InlineQueryResult import InlineQueryResultCachedDocument
from NekoRobot.modules.info import get_chat_info, get_user_info
from NekoRobot.modules.music import download_youtube_audio
from NekoRobot.utils.functions import test_speedtest
...
async def inline_help_func(__help__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/36ab7fcf96c86ecfb44c2.jpg",
...
async def alive_function(answers):
    ...
    msg = f"""
[NekoRobot](https://github.com/Xbarok/NekoRobot):
**Robot:** `{bot_state}`
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/5e1a76ef6db5bc9ae3371.jpg",
            input_message_content=InputTextMessageContent(
