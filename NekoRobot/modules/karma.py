...
@app.on_message(filters.command("karmas") & filters.group)
@capture_err
...
/karma [ON|OFF] - Enable or Disable Karma System In Your Chat.
Reply to a message with /karmas to check a user's karma
Send /karmas without replying to any message to chek karma list of top 10 users
"""
