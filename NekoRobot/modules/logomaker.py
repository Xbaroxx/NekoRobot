...
from NekoRobot import OWNER_ID, BOT_USERNAME, SUPPORT_CHAT
...
LOGO_LINKS            = ["https://telegra.ph/file/b3b8a4ba4a9d54ac9275c.jpg",
                         "https://telegra.ph/file/22f9164b706b32aaae7a3.jpg",
                         "https://telegra.ph/file/08c5fbe14cc4b13d1de05.jpg",
                         "https://telegra.ph/file/5e1a76ef6db5bc9ae3371.jpg",
...
async def lego(event):
 ...
 if event.sender_id != OWNER_ID and not quew:
  await event.reply('Please Give Me Text To Make Logo.')
  return
 ...
 try:
    ...
    fname = "NekoRobot.png"
    img.save(fname, "png")
    await telethn.send_file(event.chat_id, file=fname, caption = f"Made by @NekotpiRobot")         
    await pesan.delete()
